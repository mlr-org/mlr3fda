...
To train a model on this task we first need to extract scalar from the functional columns.
In the example below, we extract the mean of the functional columns.
...
This is also the default behaviour but we here do it explicitly for clarity's sake.
