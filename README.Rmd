...
However, it is possible to extract simple functional features using the `PipeOpFDAExtract`, which in the example below calculates the average functional responses.
