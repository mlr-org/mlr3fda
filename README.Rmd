...
To train a model on this task we create a `Graph` that first extracts features from the functional columns and then trains a regression tree.

```{r ffs, fig.width = 5, fig.height = 3}
library(mlr3pipelines)

po_fmean = po("ffs", features = c("mean", "var"))
...
Note that this is also the default behaviour but we here do it explicitly for clarity's sake.
