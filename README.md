...
| [fda.extract_new](https://mlr3fda.mlr-org.com/reference/mlr_pipeops_fda.extract_new) | Extracts Simple Features from Functional Columns | [tf](https://cran.r-project.org/package=tf)        | fda, data transform |
